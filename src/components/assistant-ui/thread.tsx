        ...
        <ThreadPrimitive.ViewportFooter className="mt-auto">
          {isEnded ? (
            ...
            <ComposerPrimitive.Root className="flex items-end gap-2 border-t border-white/10 p-3">
              <ComposerPrimitive.Input className="flex-1 resize-none rounded-xl bg-white/10 border border-white/20 px-3 py-2 text-sm text-white/90 placeholder-white/40 outline-none focus:border-white/40" />
