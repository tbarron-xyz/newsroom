...
describe("MongoDBDataStorageService", () => {
  let storage: MongoDBDataStorageService;

  beforeEach(async () => {
    storage = new MongoDBDataStorageService();
  ...
  describe("connection lifecycle", () => {
    it("connects and disconnects without error", async () => {
      const s = new MongoDBDataStorageService();
      await s.connect();
      await s.disconnect();
    });
  });
  ...
  describe("clearAllData", () => {
    it("wipes all collections", async () => {
