      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="border border-[var(--tui-border)] p-6 mt-8">
          <div className="space-y-6">
            ...
            <div className="border border-[var(--tui-border)] p-4 space-y-4">
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 border border-[var(--tui-primary)] flex items-center justify-center">
                  <svg
              ...
              <p className="tui-muted">
                Generate an AI visitor message and chatbot reply in the global
                homepage chat.
              </p>
              <button
                onClick={() => triggerJob("homepage-chat")}
                disabled={jobTriggering === "homepage-chat" || !isAdmin}
                className={`tui-btn w-full text-center ${!isAdmin ? "opacity-50 cursor-not-allowed" : ""}`}
              >
                {jobTriggering === "homepage-chat"
                  ? "Generating..."
